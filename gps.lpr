;; -*- lisp-version: "9.0 [64-bit Windows *SMP*] (Jan 17, 2019 21:16)"; cg: "9.0"; -*-

(in-package :cg-user)

(define-project :name :gps
  :modules (list (make-instance 'module :name "gpsaux.lisp")
                 (make-instance 'module :name "gps1.lisp")
                 (make-instance 'module :name "gps.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
